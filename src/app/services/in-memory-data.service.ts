  ...
  createDb() {
    const prompts: Prompt[] = [
      // --- Common/General Dev Prompts ---
      {
        ...
        prompt:
          `// 🧪 Write comprehensive REST API integration tests for the endpoints below.
// ✅ Checklist:
...
`,
        description: 'Generate robust, checklist-driven integration tests for REST APIs, including error handling and edge cases.',
        tags: ['api', 'integration-test', 'backend', 'testing', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Any',
        author: 'api_tester',
      },
      {
        ...
        prompt:
          `// 🛠️ Optimize the following SQL query for performance and readability.
// ✅ Checklist:
...
`,
        description: 'Review and optimize SQL queries for speed, clarity, and security. Provide before/after examples and rationale.',
        tags: ['sql', 'database', 'optimization', 'checklist', 'copilot-optimized'],
        category: 'Database',
        language: 'SQL',
        author: 'db_admin',
      },
      {
        ...
        prompt:
          `// 🐳 Generate a multi-stage Dockerfile for the following web application.
// ✅ Checklist:
...
`,
        description: 'Create a secure, production-ready Dockerfile for web apps using multi-stage builds and best practices.',
        tags: ['docker', 'devops', 'deployment', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'devops_guru',
      },
      {
        ...
        prompt:
          `// 🧪 Suggest comprehensive test cases for the feature below.
// ✅ Checklist:
...
`,
        description: 'List detailed, categorized test cases for any feature, including edge, negative, and security scenarios.',
...
`,
        description: 'Refactor code with clear comments, best practices, and before/after examples for maximum clarity.',
        tags: ['refactor', 'code-review', 'best-practices', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
        author: 'refactor_bot',
      },
      {
        ...
        prompt:
          `// 📄 Generate a professional README.md for a GitHub project.
// ✅ Checklist:
...
`,
        description: 'Create a comprehensive, visually appealing README.md for GitHub, including a proposed table of contents and all best practices.',
        tags: ['documentation', 'readme', 'github', 'markdown', 'checklist', 'copilot-optimized'],
      ...
      },
      {
        ...
        prompt:
          `// 🔒 Design a Solidity smart contract for secure, auditable messaging.
// ✅ Checklist:
...
`,
        description: 'Create a secure, auditable Ethereum smart contract for messaging, with access control and update tracking.',
        tags: ['ethereum', 'solidity', 'blockchain', 'smart-contract', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Solidity',
      ...
      },
      {
        ...
        prompt:
          `// 💻 Simulate a Linux terminal session.
// ✅ Checklist:
...
`,
        description: 'Emulate a Linux terminal for command-line practice and demonstration. Output only the terminal result.',
        tags: ['linux', 'terminal', 'shell', 'emulator', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Bash',
        author: 'cli_guru',
      },
...
`,
        description: 'Practice and demonstrate JavaScript console commands interactively. Output only the console result.',
        tags: ['javascript', 'console', 'emulator', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'JavaScript',
        author: 'js_console',
      },
      {
        ...
        prompt:
          `// 📊 Simulate a text-based Excel sheet (10 rows, columns A-L).
// ✅ Checklist:
...
`,
        description: 'Emulate Excel for quick, text-based spreadsheet tasks and formula practice. Output only the updated sheet.',
        tags: ['excel', 'spreadsheet', 'emulator', 'checklist', 'copilot-optimized'],
      ...
      },
      {
        ...
        prompt:
          `// 🎨 Act as a UX/UI developer for digital products.
// ✅ Checklist:
...
`,
        description: 'Offer actionable UX/UI advice for digital product design, including wireframes, usability, and accessibility tips.',
        tags: ['ux', 'ui', 'design', 'frontend', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
        author: 'ux_ui_expert',
      },
      {
        ...
        prompt:
          `// 🛡️ Act as a cybersecurity specialist.
// ✅ Checklist:
...
`,
        description: 'Develop effective cybersecurity strategies for data protection, compliance, and threat mitigation.',
        tags: ['cybersecurity', 'security', 'encryption', 'devops', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'security_pro',
      },
...
`,
        description: 'Advise on web design for optimal user experience and business alignment, with step-by-step plans.',
        tags: ['web-design', 'consulting', 'ux', 'ui', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
      ...
      },
      {
        ...
        prompt:
          `// 📊 Act as a text-based Excel emulator (10 rows, columns A-L).
// ✅ Checklist:
...
// 💡 Tip: Output only the updated sheet after each instruction.
`,
        description: 'Simulate Excel for text-based spreadsheet and formula practice. Output only the updated sheet.',
        tags: ['excel', 'spreadsheet', 'emulator', 'checklist', 'copilot-optimized'],
        category: 'Productivity',
        language: 'Any',
        author: 'sheet_bot',
      },
      {
        ...
        prompt:
          `// 🧭 As a UX/UI developer, design an intuitive navigation system for a mobile app.
// ✅ Checklist:
...
// 💡 Tip: Use diagrams or tables for clarity.
`,
        description: 'Design and improve navigation systems for mobile applications, with actionable suggestions and diagrams.',
        tags: ['ux', 'ui', 'navigation', 'mobile', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
        author: 'ux_ui_expert',
      },
      {
        ...
        prompt:
          `// 🛡️ Create a cybersecurity policy for protecting sensitive company data.
// ✅ Checklist:
...
`,
        description: 'Draft effective, actionable cybersecurity policies for organizations, covering encryption, access control, and monitoring.',
        tags: ['cybersecurity', 'policy', 'security', 'devops', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'security_pro',
      },
      {
        ...
        prompt:
          `// 🛒 Advise on web design for an e-commerce site (e.g., jewelry store).
// ✅ Checklist:
...
// 💡 Tip: Use diagrams or tables for clarity.
`,
        description: 'Advise on e-commerce web design for optimal sales, accessibility, and user experience, with actionable plans.',
        tags: ['web-design', 'ecommerce', 'ux', 'ui', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
        author: 'web_consultant',
      },
      {
        ...
        prompt:
          `// 🩺 Act as an AI-assisted doctor for medical diagnosis.
// ✅ Checklist:
//   - Use AI tools and traditional methods
//   - Combine imaging, lab tests, and physical exams
//   - Output a clear, step-by-step diagnosis
//
// Input: Patient details and symptoms
//
// 💡 Tip: Use tables or bullet points for clarity.
`,
        description: 'Leverage AI and traditional methods for medical diagnosis, providing clear, step-by-step recommendations.',
        tags: ['ai', 'doctor', 'diagnosis', 'health', 'checklist', 'copilot-optimized'],
        category: 'Other',
        language: 'Any',
        author: 'ai_doctor',
      },
      {
        ...
        prompt:
          `// ♿ Review a website for accessibility improvements.
// ✅ Checklist:
...
`,
        description: 'Improve web accessibility for all users with actionable, prioritized recommendations.',
        tags: ['web-design', 'accessibility', 'ux', 'ui', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
      ...
      },
      {
        ...
        prompt:
          `// 🖥️ Simulate a Linux command line session.
// ✅ Checklist:
...
`,
        description: 'Practice Linux command line skills interactively. Output only the command result.',
        tags: ['linux', 'cli', 'terminal', 'practice', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Bash',
        author: 'cli_guru',
      },
      {
        ...
        prompt:
          `// 🖥️ Act as a JavaScript console for practice.
// ✅ Checklist:
//   - Reply to commands with output in a code block
//   - No explanations unless asked
//   - Use curly braces for comments
...
// 💡 Tip: Output only the console result, not explanations.
`,
        description: 'Practice JavaScript console commands interactively. Output only the console result.',
        tags: ['javascript', 'console', 'practice', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'JavaScript',
        author: 'js_console',
      },
      {
        ...
        prompt:
          `// ⚙️ As a DevOps expert, suggest automation strategies for CI/CD, IaC, and monitoring.
// ✅ Checklist:
...
// 💡 Tip: Use tables or bullet points for clarity.
`,
        description: 'Advise on DevOps automation for modern software delivery, with actionable, prioritized steps.',
        tags: ['devops', 'automation', 'ci/cd', 'infrastructure', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'devops_guru',
      },
      {
        ...
        prompt:
          `// ☁️ Act as a cloud architect for scalable, secure infrastructure.
// ✅ Checklist:
...
// 💡 Tip: Use diagrams or tables for clarity.
`,
        description: 'Design cloud architectures for scalability, security, and cost optimization, with clear, actionable plans.',
        tags: ['cloud', 'architecture', 'devops', 'infrastructure', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
      ...
      },
      {
        ...
        prompt:
          `// 🔐 Review an API for security vulnerabilities.
// ✅ Checklist:
...
// 💡 Tip: Use a checklist or table for clarity.
`,
        description: 'Identify and remediate API security risks with actionable, prioritized recommendations.',
      ...
      },
      {
        ...
        prompt:
          `// 🗄️ Act as a database expert to improve data models.
// ✅ Checklist:
...
// 💡 Tip: Use diagrams or tables for clarity.
`,
        description: 'Optimize database design for performance and maintainability, with clear, actionable plans.',
        tags: ['database', 'design', 'optimization', 'checklist', 'copilot-optimized'],
        category: 'Database',
        language: 'Any',
        author: 'db_admin',
      },
      {
        ...
        prompt:
          `// ⚡ Analyze a web app and suggest frontend performance optimizations.
// ✅ Checklist:
...
// 💡 Tip: Use tables or bullet points for clarity.
`,
        description: 'Improve frontend performance for web applications with actionable, prioritized steps and best practices.',
        tags: ['frontend', 'performance', 'optimization', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
      ...
      },
      {
        ...
        prompt:
          `// 🏗️ Act as a backend architect for scalable systems.
// ✅ Checklist:
...
// 💡 Tip: Use diagrams or tables for clarity.
`,
        description: 'Design scalable backend systems for high availability, with clear, actionable plans.',
        tags: ['backend', 'scalability', 'architecture', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Any',
      ...
      },
      {
        ...
        prompt:
          `// 🔄 As a CI/CD coach, help set up continuous integration for a project.
// ✅ Checklist:
//   - Recommend tools and workflows
...
// 💡 Tip: Use tables or bullet points for clarity.
`,
        description: 'Implement CI/CD pipelines for efficient software delivery, with actionable, prioritized steps.',
        tags: ['ci/cd', 'devops', 'automation', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'ci_cd_coach',
      },
      {
        ...
        prompt:
          `// 📚 Generate clear, concise API documentation.
// ✅ Checklist:
...
`,
        description: 'Create professional API documentation for developers, with clear examples and consistent formatting.',
        tags: ['api', 'documentation', 'backend', 'checklist', 'copilot-optimized'],
        category: 'Documentation',
        language: 'Any',
        author: 'doc_expert',
      },
      {
        ...
        prompt:
          `// 🤖 Suggest ways to automate code reviews for quality and security.
// ✅ Checklist:
...
// 💡 Tip: Use tables or bullet points for clarity.
`,
        description: 'Automate code review processes for better quality and efficiency, with actionable, prioritized steps.',
        tags: ['code-review', 'automation', 'quality', 'checklist', 'copilot-optimized'],
        category: 'Testing',
        language: 'Any',
        author: 'review_bot',
      },
...
`,
        description: 'Monitor distributed systems for reliability and performance with actionable, checklist-driven strategies and tool recommendations.',
        tags: ['devops', 'monitoring', 'metrics', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'devops_guru',
      },
...
`,
        description: 'Test and improve accessibility in frontend applications with actionable, checklist-driven recommendations.',
        tags: ['frontend', 'accessibility', 'testing', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
...
`,
        description: 'Implement rate limiting for secure and reliable APIs with actionable, code-oriented strategies and best practices.',
        tags: ['backend', 'api', 'rate-limiting', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Any',
        author: 'backend_architect',
      },
...
`,
        description: 'Plan for disaster recovery in cloud environments with actionable, checklist-driven steps and compliance considerations.',
        tags: ['devops', 'disaster-recovery', 'cloud', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'devops_guru',
      },
...
`,
        description: 'Plan and execute safe database migrations with actionable, checklist-driven steps and code examples.',
        tags: ['database', 'migration', 'planning', 'checklist', 'copilot-optimized'],
        category: 'Database',
        language: 'Any',
        author: 'db_admin',
      },
...
`,
        description: 'Choose and implement effective API versioning with actionable, checklist-driven comparisons and code examples.',
        tags: ['api', 'versioning', 'strategy', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Any',
...
`,
        description: 'Select and implement state management in frontend apps with actionable, checklist-driven comparisons and code examples.',
        tags: ['frontend', 'state-management', 'architecture', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'Any',
...
`,
        description: 'Reduce cloud costs while maintaining quality with actionable, checklist-driven recommendations and visualizations.',
        tags: ['devops', 'cost-optimization', 'cloud', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'devops_guru',
      },
...
`,
        description: 'Design and implement API gateways for microservices with actionable, checklist-driven steps and code/config examples.',
        tags: ['api', 'gateway', 'microservices', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Any',
...
`,
        description: 'Develop comprehensive frontend testing strategies with actionable, checklist-driven steps and tool comparisons.',
        tags: ['frontend', 'testing', 'strategy', 'checklist', 'copilot-optimized'],
        category: 'Testing',
        language: 'Any',
...
`,
        description: 'Implement infrastructure as code for modern DevOps with actionable, checklist-driven steps and code/config examples.',
        tags: ['devops', 'infrastructure-as-code', 'automation', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
        author: 'iac_expert',
      },
...
`,
        description: 'Secure cloud deployments with industry best practices, actionable checklists, and visualizations.',
        tags: ['cloud', 'security', 'best-practices', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Any',
...
`,
        description: 'Generate robust Jasmine unit tests for Angular components or services using best practices and checklist-driven coverage.',
        tags: ['angular', 'unit-test', 'jasmine', 'testing', 'checklist', 'copilot-optimized'],
        category: 'Testing',
        language: 'TypeScript',
        author: 'ng_tester',
      },
...
`,
        description: 'Generate validation logic and error messages for Angular Reactive Forms using built-in and custom validators, with checklist-driven clarity.',
        tags: ['angular', 'forms', 'validation', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'TypeScript',
        author: 'ng_forms',
      },
...
`,
        description: 'Best practices for creating Angular services using RxJS for reactive state management, with checklist-driven code and examples.',
        tags: ['angular', 'rxjs', 'service', 'state-management', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'TypeScript',
        author: 'rxjs_guru',
      },
...
`,
        description: 'Improve Angular components using performance optimization, code best practices, and checklist-driven refactoring.',
        tags: ['angular', 'component', 'best-practices', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'TypeScript',
        author: 'ng_architect',
      },
...
`,
        description: 'Understand Angular Dependency Injection with examples, core concepts, and checklist-driven clarity.',
        tags: ['angular', 'dependency-injection', 'architecture', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'TypeScript',
        author: 'ng_di',
      },
...
`,
        description: 'Implement Angular routing with lazy loading to optimize performance and modularity, using checklist-driven code and explanations.',
        tags: ['angular', 'routing', 'lazy-loading', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'TypeScript',
        author: 'ng_router',
      },
...
`,
        description: 'Automate end-to-end testing of Angular features using Cypress, with checklist-driven code and best practices.',
        tags: ['angular', 'e2e', 'cypress', 'testing', 'checklist', 'copilot-optimized'],
        category: 'Testing',
        language: 'TypeScript',
        author: 'ng_e2e',
      },
...
`,
        description: 'Optimize Angular applications by applying best practices to improve speed and reduce unnecessary renders, with checklist-driven code and explanations.',
        tags: ['angular', 'performance', 'optimization', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'TypeScript',
        author: 'ng_perf',
      },
...
`,
        description: 'Write reusable and clean custom pipes for transforming data in Angular templates, with checklist-driven code and examples.',
...
`,
        description: 'Add multi-language support in Angular apps using the built-in i18n tools and translation files, with checklist-driven code and examples.',
        tags: ['angular', 'i18n', 'internationalization', 'checklist', 'copilot-optimized'],
        category: 'Frontend',
        language: 'TypeScript',
        author: 'ng_i18n',
      },
      // --- Java, Microservices, and Spring Boot Prompts ---
      {
        ...
        prompt:
          `// 🚀 Generate a Spring Boot REST API scaffold for the following entity.
// ✅ Checklist:
...
`,
        description: 'Scaffold a complete Spring Boot REST API with layered architecture, DTOs, validation, and best practices.',
        tags: ['java', 'spring-boot', 'rest', 'api', 'scaffold', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Java',
        author: 'spring_guru',
      },
      {
        ...
        prompt:
          `// 🧩 Create a Java microservice with OpenAPI documentation and Docker support.
// ✅ Checklist:
...
`,
        description: 'Build a Java microservice with OpenAPI docs, health checks, and Docker support using Spring Boot or Micronaut.',
        tags: ['java', 'microservices', 'spring-boot', 'openapi', 'docker', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Java',
      ...
      },
      {
        ...
        prompt:
          `// 🔒 Review and improve security for a Spring Boot application.
// ✅ Checklist:
...
`,
        description: 'Apply security best practices to Spring Boot apps, including endpoint protection, password encoding, and input validation.',
        tags: ['java', 'spring-boot', 'security', 'best-practices', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Java',
        author: 'security_pro',
      },
      {
        ...
        prompt:
          `// 🧪 Write JUnit 5 unit tests for the following Java class or method.
// ✅ Checklist:
...
`,
        description: 'Generate robust JUnit 5 tests for Java code, using Mockito for mocking and checklist-driven coverage.',
        tags: ['java', 'junit', 'testing', 'unit-test', 'checklist', 'copilot-optimized'],
        category: 'Testing',
        language: 'Java',
        author: 'java_tester',
      },
      {
        ...
        prompt:
          `// 🔗 Suggest communication patterns for Spring Boot microservices.
// ✅ Checklist:
...
`,
        description: 'Choose and implement communication patterns for Spring Boot microservices, with code/config examples and trade-off analysis.',
        tags: ['java', 'spring-boot', 'microservices', 'communication', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Java',
      ...
      },
      {
        ...
        prompt:
          `// ⚠️ Review and improve exception handling in the following Java code.
// ✅ Checklist:
...
`,
        description: 'Refine exception handling in Java and Spring Boot code, using custom exceptions, logging, and best practices.',
        tags: ['java', 'exception-handling', 'spring-boot', 'best-practices', 'checklist', 'copilot-optimized'],
        category: 'Backend',
        language: 'Java',
        author: 'java_expert',
      },
      {
        ...
        prompt:
          `// 🧪 Write Spring Boot integration tests for the following REST API or service.
// ✅ Checklist:
...
`,
        description: 'Generate comprehensive integration tests for Spring Boot APIs/services using @SpringBootTest and MockMvc/TestRestTemplate.',
        tags: ['java', 'spring-boot', 'integration-test', 'testing', 'checklist', 'copilot-optimized'],
        category: 'Testing',
        language: 'Java',
      ...
      },
      {
        ...
        prompt:
          `// 📊 Set up observability (metrics, tracing, logging) for a Java microservice.
// ✅ Checklist:
...
`,
        description: 'Implement observability in Java microservices using Micrometer/OpenTelemetry, centralized logging, and health checks.',
        tags: ['java', 'microservices', 'observability', 'metrics', 'logging', 'checklist', 'copilot-optimized'],
        category: 'DevOps',
        language: 'Java',
